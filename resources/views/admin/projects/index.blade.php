        ...
        @foreach ($projects as $project)
            <div class="card mb-3">
                ...
                <div class="card-body">
                    ...
                    <div>
                        <a href="{{ route('admin.projects.show', $project->slug) }}" class="btn btn-primary">Info</a> {{-- uso $project->slug al posto di $project->id in modo da usare lo slug al posto dell'id --}}
